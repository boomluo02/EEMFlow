...
import sys
sys.path.append("/home/luoxinglong/unite_raft/model/KPAflow")
from update import BasicUpdateBlock, SmallUpdateBlock
from extractor import BasicEncoder, SmallEncoder
from corr import CorrBlock, AlternateCorrBlock
from model_utils import bilinear_sampler, coords_grid, upflow8, InputPadder
...
class RAFTKPARES(nn.Module):
    def __init__(self, config, n_first_channels=5):
        super(RAFTKPARES, self).__init__()
        args = get_args()
        self.args = args
...
class RAFTKPARES_IN(nn.Module):
    def __init__(self, config, n_first_channels=5):
        super(RAFTKPARES_IN, self).__init__()
        args = get_args()
        self.args = args
